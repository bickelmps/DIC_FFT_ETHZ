function [tpostfiltx,tpostfilty] = med_filt(T0,t,med,wi);
%%_________________________________________________________________________
%% Median filter for 2D displacements
